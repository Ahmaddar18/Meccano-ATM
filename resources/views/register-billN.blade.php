				...
				@include('cancel-buttonN')
					<div align="center" vertical-align="center">
							<div style="padding:10px 0">
									<h2 aria-label="Vennligst skriv inn ditt kundenummer">Vennligst skriv inn ditt kundenummer &nbsp&nbsp&nbsp</h2>
							</div>
						...
						<div style="padding:10px 10px 0">
							...
							<div style="padding:10px 0">
									<button class="button button4" onclick="addAmmount('0')" aria-label="null">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp0 &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</button>
									<button class="button button4" onclick="addAmmount('C')" aria-label="klar">&nbsp&nbsp Klar &nbsp&nbsp</button>
								</div>

						<div style="padding:10px 0">
								<button class="button button3" onclick="Withdraw()" aria-label="Bekrefte">Bekrefte &nbsp </button>
							</div>
                    </div>
				</div>
			</section>
...
<script>
	...
	function Withdraw()
	{
		...
		{
		alert("Vennligst skriv inn gyldig kundenummer, det kan ikke være mindre enn 8")
		}
		else
		window.location.href = "/pay-billN";
	}
</script>
</html>